...
async function getDecision(id: string): Promise<NlrcDetail | null> {
  const { data, error } = await supabaseServer
    .from('nlrc_decisions')
    .select('id, serial_number, case_number, title, department, decision_date, case_type, decision_result, keywords_matched, reason_category, holding_points, holding_summary, summary, summary_short, key_issue, url')
    .eq('id', id)
    .single();
  ...
  const jsonLd = {
    ...
    '@graph': [
      ...
      },
      {
        ...
        inLanguage: 'ko',
        keywords: [
          ...(item.reason_category || []).map(translateReasonCategory),
        ...
        <div className="lg:grid lg:grid-cols-[1fr_280px] lg:gap-10">
          ...
          <article>
            ...
            <section className="mt-10 space-y-4">
                ...
                <Link
                  href={`/database?q=${encodeURIComponent(
                    item.reason_category?.[0]
                      ...
                      : item.keywords_matched?.[0] || item.case_number
                  )}`}
              ...
              <div className="rounded-2xl p-6 sm:p-8 text-center" style={{ backgroundColor: 'var(--grey-900)' }}>
          ...
          <aside className="hidden lg:block">
            <div className="sticky top-24 space-y-6">
              ...
              {/* CTA Sidebar */}
              <div className="rounded-2xl p-5" style={{ backgroundColor: 'var(--grey-900)' }}>
