...
const faqJsonLd = {
  ...
  mainEntity: [
    ...
    {
      '@type': 'Question',
      name: '5인 미만 사업장도 근로자의 날 수당을 받나요?',
      acceptedAnswer: {
        '@type': 'Answer',
        text: '근로자의 날(5/1)은 「근로자의 날 제정에 관한 법률」에 따라 5인 미만 사업장에도 적용되는 유급휴일입니다. 다만 가산수당(1.5배·2배)은 근로기준법 제56조 사항이라 5인 미만 사업장은 의무가 없습니다.',
      },
    },
    {
      '@type': 'Question',
    ...
    {
      '@type': 'Question',
      name: '관공서 공휴일과 근로자의 날은 다른가요?',
      acceptedAnswer: {
        '@type': 'Answer',
        text: '근거 법령이 다릅니다. 관공서 공휴일(빨간날)은 근로기준법 제55조·시행령 제30조 — 5인 이상 사업장만 유급휴일입니다. 근로자의 날(5/1)은 「근로자의 날 제정에 관한 법률」 — 5인 미만 사업장 포함 모든 사업장 유급휴일입니다.',
      },
    },
  ],
};
...
export const metadata: Metadata = {
  ...
  description:
    '근로자의 날(5/1)·관공서 공휴일에 일하면 얼마 더 받나? 5인 이상/미만 × 월급제·일용직·시급제(파트) 6분기 정확 계산. 시급에 주휴수당 포함 케이스까지 자동 분리. 카톡 공유 지원.',
  keywords: ['공휴일 수당 계산기', '노동절 수당', '근로자의 날 수당', '휴일근로 가산수당', '5인 미만', '시급 주휴수당'],
