...
export const metadata: Metadata = {
  title: '노동법 FAQ — 11,500건+ 질문과 답변',
  description: '임금, 해고, 근로시간, 퇴직금, 연차휴가, 징계 등 33개 카테고리별 노동법 FAQ를 검색하세요. 공인노무사가 검수한 11,500건 이상의 Q&A를 제공합니다.',
  alternates: { canonical: `${SITE_URL}/faq` },
  openGraph: {
    title: '노동법 FAQ | 노란봉투법 가이드',
    description: '33개 카테고리, 11,500건+ 노동법 Q&A. 임금·해고·퇴직금·연차 등.',
    url: `${SITE_URL}/faq`,
    type: 'website',
    locale: 'ko_KR',
  ...
  const jsonLd = {
    ...
    '@graph': [
      ...
      },
      {
        ...
        '@id': `${SITE_URL}/faq`,
        name: '노동법 FAQ',
        description: '33개 카테고리, 11,500건 이상의 노동법 질문과 답변',
        inLanguage: 'ko',
